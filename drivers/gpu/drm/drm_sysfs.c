	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((dsi_panel_name == DSI_PANEL_SAMSUNG_ANA6705) || (dsi_panel_name == DSI_PANEL_SAMSUNG_AMSS644_VK04)) {
		...
		if (((panel_stage_info == 0x02) || (panel_stage_info == 0x03)
			...
			pr_err("20801 panel stage version is T0/DVT2/PVT&MP");
		}
	}
		...
		struct device_attribute *attr, char *buf)
{
	...
	if ((dsi_panel_name == DSI_PANEL_SAMSUNG_AMSS644_VK04) || (dsi_panel_name == DSI_PANEL_SAMSUNG_ANA6705)) {
